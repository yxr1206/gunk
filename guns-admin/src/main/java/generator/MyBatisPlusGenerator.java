...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("F:\\guns-workspace\\guns\\guns-admin\\src\\main\\java");//这里写你自己的java目录
...
//        strategy.setTablePrefix(new String[]{"house_manager"});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"house_manager"});
